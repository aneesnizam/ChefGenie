...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'name', 'age', 'country', 'isCook','email', 'profile', 'favorites_count', 'days_active']
    ...
    def get_days_active(self, obj):
        ...
        earliest_favorite = Favorite.objects.filter(user=obj).order_by('created_at').first()
