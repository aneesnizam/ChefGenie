...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background font-['Inter']">
      ...
      <Routes>
        <Route path="/" element={<Islogged><LandingPage /></Islogged>} />
        <Route path="/login" element={<Islogged><LoginPage /></Islogged>} />
        <Route path="/register" element={<Islogged><RegisterPage /></Islogged>} />
